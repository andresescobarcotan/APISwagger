...
fetch('https://$(catalog.host)/cross-recibos/api/v1/polizas/{id-poliza}/recibos?desdeFecha=2020-04-20&hastaFecha=2020-04-20',
{
  method: 'GET',
...
fetch('https://$(catalog.host)/cross-recibos/api/v1/recibos-by-nif?fechaConsulta=2020-04-20',
{
  method: 'GET',
