...
<h1 id="cambio-sobre-el-swagger-masmovil-ticketing-api-inbound-external-systems-masmovil-">Cambio sobre el swagger. MasMovil Ticketing API - Inbound (External Systems > MasMovil) v1.1.1</h1>
